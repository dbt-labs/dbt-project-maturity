...
Contact the following individuals to get full access before contributing:

- Snowflake access: [Idris Elba](idris@hollywood.com)
- dbt Cloud access: [Tony Hawk](tony@skateboards.com)
- Jira Access: [Conan O'Brien](conan@hahaveryfunny.com)

The below guide should be followed when creating new models or updating the contents of models. 
